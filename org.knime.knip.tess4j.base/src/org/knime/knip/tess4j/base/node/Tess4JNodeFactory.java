 ...
 *         Zinsmaier</a>
 */
public class Tess4JNodeFactory<T extends RealType<T>> extends
	 ...
	 */
	@Override
	public ValueToCellNodeModel<ImgPlusValue<T>, StringCell> createNodeModel() {
		return new Tess4JNodeModel<T>();
	}
