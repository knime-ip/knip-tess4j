...
public class ImageDeskew {
    ...
    private ImageDeskew.HoughLine[] getTop(final int count) {

        final ImageDeskew.HoughLine[] hl = new ImageDeskew.HoughLine[count];
    ...
    private void calc() {
        final int hMin = (int) ((this.cImage.getHeight()) / 4.0);
        final int hMax = (int) ((this.cImage.getHeight()) * 3.0 / 4.0);
        init();
    ...
    private void calc(final int x, final int y) {
        double d;
        int dIndex;
        int index;
